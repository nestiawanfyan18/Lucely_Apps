...
import 'package:lucely/pages/homes/educaton_article/view_article_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/eduation-view-article': (context) => ViewArticlePage(),
        ...
        '/podcast-main': (context) => PodcastMainPage(),
      },
    );
  }
}
